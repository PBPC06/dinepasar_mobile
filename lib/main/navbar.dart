...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Widget> _pages = <Widget>[
    ...
    const ReviewPage(), // Placeholder for Review Page
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          _pages[_selectedIndex], // Show the selected page from the _pages list
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: _selectedIndex, // Set the current selected tab
        onTap: _onItemTapped, // Handle tab switch
        selectedItemColor:
            Colors.yellow[700], // Highlight color for the selected item
        unselectedItemColor:
            Colors.grey, // Set the color of unselected items to grey
